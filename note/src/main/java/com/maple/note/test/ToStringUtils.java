...
public class ToStringUtils {
    ...
    private static List<String> jsonFieldFilter = Collections.emptyList();
     ...
     *
     * @param toString        到字符串
     * @param jsonFieldFilter JSON 字段筛选 【字段为json数据时，需要过滤当前字段】
     * @return {@link String}
     * @throws ParseException 解析异常
     */
    public static String toJSONString(String toString, List<String> jsonFieldFilter) throws ParseException {
        ToStringUtils.jsonFieldFilter = jsonFieldFilter;
        return JSON.toJSONString(toMap(toString));
    }
    ...
    private static Object buildTypeValue(String key, String value) throws ParseException {
        ...
        List<String> jsonFieldList = ToStringUtils.jsonFieldFilter;

        if (jsonFieldList.contains(key)){
